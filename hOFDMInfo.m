...
%   INFO = hOFDMInfo(GNB) provides OFDM dimensional information. 
%   It also returns extended numerology information about the 1ms slot
%   structure across the range of subcarrier spacings.
%  
...
%                       which windowing and overlapping of OFDM symbols is
%                       applied
...
%   (not considering any additional FIR filtering).
%
%   See also nrOFDMModulate, nrOFDMDemodulate.
